...
enum DamageFlags
{
    DAMAGE_BYPASSES_SHIELD = 0, //1
    DAMAGE_HITS_SHIELD_AND_BODY = 1, //2
    DAMAGE_FREEZE = 2, // 4
    DAMAGE_DOESNT_CAUSE_FLASH = 3, // 8
    DAMAGE_DOESNT_LEAVE_BODY = 4, // 16
    DAMAGE_SPIKE = 5 // 32
};
enum DamageRangeFlags
{
    ...
    DAMAGES_MINDCONTROLLED_ZOMBIES
};
enum Dialogs
{
    DIALOG_NEW_GAME,                            
...
enum ZombiePhase
{
    ...
    PHASE_NEWSPAPER_READING_COLORGRAY,
    PHASE_NEWSPAPER_MADDENING,
    PHASE_NEWSPAPER_MAD,
    PHASE_ICESHROOM_IDLE,
    PHASE_ICESHROOM_WALKING,
    PHASE_ICESHROOM_ICEEXPLODES,
    PHASE_ICESHROOM_DONEEXPLODES,
    PHASE_TORCHWOOD_NOFLAME,
    PHASE_TORCHWOOD_HASFLAME,
    PHASE_TORCHWOOD_RELEASEDFLAME,
    PHASE_FOOTBALL_IDLE,
    PHASE_FOOTBALL_WALKING,
    PHASE_FOOTBALL_RUNNING,
    ...
    PHASE_DANCER_DANCING_IN_HAIRCOLORED1,
    PHASE_DANCER_DANCING_IN_HAIRCOLORED2,
...
enum ZombieType
{
    ...
    ENUM_AUTO_VALUE(ZOMBIE_TORCHWOOD_HEAD)
